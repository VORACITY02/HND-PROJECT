...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        <a href="{{ route('admin.users.index') }}" class="text-blue-700 hover:text-blue-800 font-medium inline-flex items-center mb-4">
    ...
    <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-xl shadow-lg border border-slate-200 p-8">
        ...
        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-slate-200">
            ...
            <button type="submit" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold shadow-sm transition-all">
                Create User
            </button>
        </div>
    </form>
