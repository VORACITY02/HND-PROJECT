...
<div class="mb-6">
    <a href="{{ route('messages.index') }}" class="inline-flex items-center text-green-900 hover:text-green-950 font-medium">
...
<div class="bg-white rounded-lg shadow border p-6">
    <form method="POST" action="{{ route('messages.store') }}">
        ...
        <div class="flex gap-3">
            <button type="submit" class="px-6 py-3 bg-lime-400 text-green-950 rounded hover:bg-lime-300 font-medium border border-lime-200">
                Send Message
            </button>
