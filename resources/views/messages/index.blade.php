...
<div class="bg-slate-800 text-white rounded-xl p-8 mb-8 shadow-xl">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="{{ route('messages.sent') }}" class="bg-slate-700/50 hover:bg-slate-600 px-6 py-3 rounded-lg font-medium transition-all border border-slate-600">
                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/>
                </svg>
                Sent Messages
            </a>
            <a href="{{ route('messages.create') }}" class="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-medium transition-all shadow-lg">
                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    @if($message->is_broadcast)
                                        <span class="px-3 py-1 text-xs bg-purple-100 text-purple-800 rounded-full font-medium border border-purple-200">
