...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-slate-900 text-white antialiased">
        ...
        <div class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
            <!-- Header -->
            <header class="bg-slate-800/50 backdrop-blur border-b border-blue-700/30">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-blue-300 text-xs">Professional Learning Platform</p>
                            </div>
                        </div>
                            ...
                            <nav class="flex space-x-4">
                                @auth
                                    <a href="{{ url('/dashboard') }}" 
                                       class="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-lg font-medium transition-colors shadow-lg">
                                        Dashboard
                                    </a>
                                @else
                                    <a href="{{ route('login') }}" 
                                       class="bg-slate-700 hover:bg-slate-600 px-6 py-2 rounded-lg font-medium transition-colors border border-slate-600">
                                        Login
                                    </a>
            ...
            <main class="container mx-auto px-6 py-16">
                ...
                <div class="text-center max-w-4xl mx-auto mb-16">
                    <h2 class="text-5xl font-bold text-white mb-6">
                        ...
                        <span class="text-blue-400">Professional Excellence</span>
                    </h2>
                    ...
                    @guest
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="{{ route('register') }}" 
                               class="bg-blue-600 hover:bg-blue-700 px-8 py-4 rounded-lg font-semibold text-lg shadow-xl transition-all transform hover:scale-105">
                                Start Your Journey
                            </a>
                            <a href="{{ route('login') }}" 
                               class="bg-transparent border-2 border-blue-500 hover:bg-blue-500 px-8 py-4 rounded-lg font-semibold text-lg transition-all">
                                Sign In
                            </a>
                        </div>
                    @endguest
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div class="bg-slate-800/50 backdrop-blur border border-blue-700/30 rounded-xl p-8 text-center shadow-xl">
                ...
                <!-- Stats Section -->
                <div class="bg-slate-800/30 backdrop-blur border border-blue-700/20 rounded-2xl p-12 text-center shadow-2xl">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div class="space-y-2">
                            ...
                            <div class="text-slate-300 font-medium">User Roles</div>
                            <div class="text-sm text-slate-400">Admin, Staff, User</div>
                        </div>
                        
                        <div class="space-y-2">
                            <div class="text-3xl font-bold text-blue-400">∞</div>
                            <div class="text-slate-300 font-medium">Messages</div>
                            <div class="text-sm text-slate-400">Individual & Broadcast</div>
                        </div>
                        
                        <div class="space-y-2">
                            <div class="text-3xl font-bold text-blue-400">24/7</div>
                            <div class="text-slate-300 font-medium">Monitoring</div>
                            <div class="text-sm text-slate-400">Real-time Tracking</div>
                        </div>
                        
                        <div class="space-y-2">
                            <div class="text-3xl font-bold text-blue-400">100%</div>
                            <div class="text-slate-300 font-medium">Secure</div>
                            <div class="text-sm text-slate-400">Protected Access</div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <footer class="bg-slate-800/50 backdrop-blur border-t border-blue-700/30 mt-20">
